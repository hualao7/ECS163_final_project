...
$(document).ready(function() {
    ...
    d3.csv("data/timesData_top100_sixYears_rankingByTotalScore_withIndex.csv", function (data) {
        ...
        mapChart
            ...
            .marker(function(d) {
                var id = d.key[2];
                var icon = L.icon({iconSize: iconSize, iconAnchor: iconAnchor, popupAnchor: popupAnchor, iconUrl: 'img/marker.png'});
        ...
        dataCount
            ...
            .html({
                ...
                ' | <a href=\'javascript: resetAll_exceptMap_New();\' style=\'color:black;\'>Reset All</a>',
